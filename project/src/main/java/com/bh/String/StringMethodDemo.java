...
public class StringMethodDemo {
    ...
    public void method02(){
        ...
        String string01_=new String("Hello");
    ...
    public void method04(){
        ...
        System.out.println("substring():" + string01.substring(0,string01.length()));   //输出字符串为 Hello World
    }
    ...
    */
    public String practice03(int[] arr){
        ...
        for (int num:arr) {
            str=str+String.valueOf(num)+",";    //遍历数组加入字符串中
        }
